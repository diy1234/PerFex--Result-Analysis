...
function AuthForm({ setDashboard, darkMode, setDarkMode }) {
...
{showForgot && (
	<div className="forgot-modal">
		<div className="forgot-box">
			...
			<input className="forgot-input" type="email" placeholder="Email" value={forgotEmail} onChange={(e)=>setForgotEmail(e.target.value)} />
			...
			<div style={{display:'flex', gap:8, marginTop:12}}>
				...
				<button className="forgot-btn" style={{background:'#ccc',color:'#000'}} onClick={()=>{ setShowForgot(false); setForgotEmail(''); setForgotMsg(''); }}>Close</button>
			</div>
		</div>
	</div>
)}
