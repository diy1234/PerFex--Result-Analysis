...
export const adminAPI = {
  ...
  /** Dashboard stat cards → replaces hardcoded 120, 15, 6, 87% */
  ...
  /**
   * Leaderboard → replaces sampleData in AdminDashboard.js
   *   const data = await adminAPI.getLeaderboard({ course: 'MCA', session: '2024-25' });
   *   // data = [{ name, course, marks }, ...]
   */
